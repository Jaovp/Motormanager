import {
  ...
  useResourceContext,
  useTranslate
} from "./chunk-YTARE2JD.js";
import "./chunk-MBII2DXM.js";
import "./chunk-BMSTOH67.js";
import "./chunk-4NBDYBUG.js";
import "./chunk-7PGFENZD.js";
import "./chunk-ZGB4ZQPY.js";
import {
  Card_default,
  ...
  yellow_default
} from "./chunk-DEA5X5PK.js";
import "./chunk-UCOH6HGP.js";
import {
  Box_default
} from "./chunk-LGDMLIMK.js";
import {
  useTheme
} from "./chunk-OOWOPKJU.js";
import "./chunk-5Z7HD3YH.js";
import "./chunk-THYS4I27.js";
import "./chunk-PKAII63E.js";
import "./chunk-QTQFZSY2.js";
import {
  require_createSvgIcon,
  require_interopRequireDefault
} from "./chunk-HYJYTIP7.js";
import "./chunk-OPKW6X64.js";
import {
  applyStyles_default,
  createPopper,
  init_lib
} from "./chunk-JF3WSCMK.js";
import {
  require_react_dom
...
function getText(node, options3) {
  const range = {
    from: 0,
  ...
  return new InputRule({
    ...
    handler: ({ state, range, match }) => {
      ...
      if (match[1]) {
        ...
        tr2.replaceWith(start, end, newNode);
      }
...
var useEditor = (options3 = {}, deps = []) => {
  ...
  (0, import_react.useEffect)(() => {
    let isMounted = true;
    const instance = new Editor2(options3);
    setEditor(instance);
    ...
    props: {
      handlePaste: (view, event, slice2) => {
        ...
        slice2.content.descendants((node) => {
          if (node.marks.some((mark) => mark.type.name === options3.type.name)) {
            isAlreadyLink = true;
          }
        });
        if (isAlreadyLink) {
        ...
        if (!selection.empty && options3.linkOnPaste) {
          const pastedLink = (link === null || link === void 0 ? void 0 : link.href) || null;
          if (pastedLink) {
            options3.editor.commands.setMark(options3.type, { href: pastedLink });
            return true;
          }
        }
        const firstChildIsText = ((_a = slice2.content.firstChild) === null || _a === void 0 ? void 0 : _a.type.name) === "text";
        const firstChildContainsLinkMark = (_b = slice2.content.firstChild) === null || _b === void 0 ? void 0 : _b.marks.some((mark) => mark.type.name === options3.type.name);
        if (firstChildIsText && firstChildContainsLinkMark || !options3.linkOnPaste) {
          return false;
        }
        if (link && selection.empty) {
          options3.editor.commands.insertContent(`<a href="${link.href}">${link.href}</a>`);
          return true;
        }
        const { tr: tr2 } = state;
        ...
        slice2.content.forEach((node) => {
          ...
          if (fragmentLinks.length > 0) {
            ...
            fragmentLinks.forEach((fragmentLink) => {
              ...
              const hasMark = tr2.doc.rangeHasMark(linkStart, linkEnd, options3.type);
              if (!hasMark) {
                tr2.addMark(linkStart, linkEnd, options3.type.create({ href: fragmentLink.href }));
              }
            });
          }
        ...
        if (tr2.docChanged && !deleteOnly && hasFragmentLinks) {
          options3.editor.view.dispatch(tr2);
          return true;
        }
        return false;
      }
...
var TiptapEditorProvider = function(_a) {
  ...
  return React2.createElement(TiptapEditorContext.Provider, { value }, children);
};
...
var FormatButtons = function(props) {
  ...
  return React3.createElement(
    ...
    React3.createElement(
      ...
      React3.createElement(import_FormatBold.default, { fontSize: "inherit" })
    ),
    React3.createElement(
      ToggleButton_default,
      { value: "italic", "aria-label": italicLabel, title: italicLabel },
      React3.createElement(import_FormatItalic.default, { fontSize: "inherit" })
    ),
    React3.createElement(
      ToggleButton_default,
      { value: "underline", "aria-label": underlineLabel, title: underlineLabel },
      React3.createElement(import_FormatUnderlined.default, { fontSize: "inherit" })
    ),
    React3.createElement(
      ToggleButton_default,
      { value: "strike", "aria-label": strikeLabel, title: strikeLabel },
      React3.createElement(import_FormatStrikethrough.default, { fontSize: "inherit" })
    ),
    React3.createElement(
      ToggleButton_default,
      { value: "code", "aria-label": codeLabel, title: codeLabel },
      React3.createElement(import_Code.default, { fontSize: "inherit" })
    )
  );
};
...
var ListButtons = function(props) {
  ...
  return React4.createElement(
    ...
    React4.createElement(
      ...
      React4.createElement(import_FormatListBulleted.default, { fontSize: "inherit" })
    ),
    React4.createElement(
      ToggleButton_default,
      { value: "orderedList", "aria-label": numberListLabel, title: numberListLabel },
      React4.createElement(import_FormatListNumbered.default, { fontSize: "inherit" })
    )
  );
};
...
var AlignmentButtons = function(props) {
  ...
  return React5.createElement(
    ...
    React5.createElement(
      ...
      React5.createElement(import_FormatAlignLeft.default, { fontSize: "inherit" })
    ),
    React5.createElement(
      ToggleButton_default,
      { value: "center", "aria-label": centerLabel, title: centerLabel },
      React5.createElement(import_FormatAlignCenter.default, { fontSize: "inherit" })
    ),
    React5.createElement(
      ToggleButton_default,
      { value: "right", "aria-label": rightLabel, title: rightLabel },
      React5.createElement(import_FormatAlignRight.default, { fontSize: "inherit" })
    ),
    React5.createElement(
      ToggleButton_default,
      { value: "justify", "aria-label": justifyLabel, title: justifyLabel },
      React5.createElement(import_FormatAlignJustify.default, { fontSize: "inherit" })
    )
  );
};
...
var LinkButtons = function(props) {
  ...
  return React6.createElement(
    ...
    React6.createElement(import_InsertLink.default, { fontSize: "inherit" })
  );
};
...
var QuoteButtons = function(props) {
  ...
  return React7.createElement(
    ...
    React7.createElement(import_FormatQuote.default, { fontSize: "inherit" })
  );
};
...
var ClearButtons = function(props) {
  ...
  return React8.createElement(
    ...
    React8.createElement(import_FormatClear.default, { fontSize: "inherit" })
  );
};
...
var LevelSelect = function(props) {
  ...
  var handleMenuItemClick = function(event, index) {
    ...
    var selectedItem = options2[index];
    ...
    React9.createElement(
      ...
      React9.createElement(
        ...
        { button: true, "aria-haspopup": "true", "aria-controls": "level-menu", "aria-label": translate("ra.tiptap.current_level", {
          _: "Current level"
        }), disabled: !(editor === null || editor === void 0 ? void 0 : editor.isEditable), onClick: handleClickListItem, className: clsx_m_default((_a = {}, _a[classes.sizeSmall] = size === "small", _a[classes.sizeLarge] = size === "large", _a)) },
        React9.createElement(ListItemText_default, { primary: translate(selectedOption.label, {
          _: selectedOption.defaultLabel
        }) }),
        React9.createElement(import_ArrowDropDown.default, null)
      )
    ),
    React9.createElement(Menu_default, { anchorEl: anchorElement, open: Boolean(anchorElement), id: "level-menu", onClose: handleClose }, options2.map(function(option, index) {
      return React9.createElement(MenuItem_default, { key: option.label, selected: option === selectedOption, onClick: function(event) {
...
var ImageButtons = function(props) {
  ...
  var addImage = React10.useCallback(function() {
  ...
  return React10.createElement(
    ...
    React10.createElement(import_Image.default, { fontSize: "inherit" })
  );
};
...
var ColorButtons = function(props) {
  var translate = useTranslate();
  var editor = useTiptapEditor();
  var _a = React11.useState(false), showColorChoiceDialog = _a[0], setShowColorChoiceDialog = _a[1];
  var _b = React11.useState(ColorType.FONT), colorType = _b[0], setColorType = _b[1];
    ...
    React11.createElement(
      ...
      React11.createElement(
        ...
        React11.createElement(
          ...
          React11.createElement(import_FormatColorText.default, { fontSize: "inherit" })
        ),
        React11.createElement(
          ToggleButton_default,
          ...
          React11.createElement(import_FontDownload.default, { fontSize: "inherit" })
        )
      ),
      showColorChoiceDialog && React11.createElement(ColorChoiceDialog, { editor, close: function() {
        return setShowColorChoiceDialog(false);
      }, colorType })
    )
  );
...
var ColorChoiceDialog = function(_a) {
  ...
  return React11.createElement(Card_default, { sx: {
    position: "absolute",
    top: 38,
    ...
    return React11.createElement(Box_default, { key: "shade-".concat(shade), sx: { display: "flex", flexDirection: "row", gap: 1 } }, colors.map(function(color, row) {
      return React11.createElement(Box_default, {
...
var OutsideListener = function(_a) {
  ...
  return React11.createElement("div", { className, ref: wrapperRef }, children);
};
...
var RichTextInputToolbar = function(props) {
  var _a = props.size, size = _a === void 0 ? "medium" : _a, _b = props.children, children = _b === void 0 ? React12.createElement(
    React12.Fragment,
    null,
    React12.createElement(LevelSelect, { size }),
    React12.createElement(FormatButtons, { size }),
    React12.createElement(ColorButtons, { size }),
    React12.createElement(AlignmentButtons, { size }),
    React12.createElement(ListButtons, { size }),
    React12.createElement(LinkButtons, { size }),
    React12.createElement(ImageButtons, { size }),
    React12.createElement(QuoteButtons, { size }),
    React12.createElement(ClearButtons, { size })
  ) : _b, rest = __rest(props, ["size", "children"]);
  return React12.createElement(Root2, __assign9({ className: classes2.root }, rest), children);
};
...
var RichTextInput = function(props) {
  var _a, _b;
  var className = props.className, _c = props.defaultValue, defaultValue = _c === void 0 ? "" : _c, _d = props.disabled, disabled = _d === void 0 ? false : _d, _e = props.editorOptions, editorOptions = _e === void 0 ? DefaultEditorOptions : _e, fullWidth = props.fullWidth, helperText = props.helperText, label = props.label, _f = props.readOnly, readOnly = _f === void 0 ? false : _f, source = props.source, sx = props.sx, toolbar = props.toolbar;
  var resource = useResourceContext(props);
  var _g = useInput(__assign10(__assign10({}, props), { source, defaultValue })), id = _g.id, field = _g.field, isRequired = _g.isRequired, fieldState = _g.fieldState, isSubmitted = _g.formState.isSubmitted;
  ...
  (0, import_react10.useEffect)(function() {
    ...
    editor.setOptions({
      ...
      editorProps: __assign10(__assign10({}, editorOptions === null || editorOptions === void 0 ? void 0 : editorOptions.editorProps), { attributes: __assign10(__assign10({}, (_a2 = editorOptions === null || editorOptions === void 0 ? void 0 : editorOptions.editorProps) === null || _a2 === void 0 ? void 0 : _a2.attributes), { id }) })
    });
  }, [
    disabled,
    editor,
  ...
  return React13.createElement(
    Root3,
    { className: clsx_m_default("ra-input", "ra-input-".concat(source), className, fullWidth ? "fullWidth" : ""), sx },
...
var RichTextInputContent = function(_a) {
  ...
  return React13.createElement(
    ...
    React13.createElement(
      FormHelperText_default,
      { className: (isTouched || isSubmitted) && invalid ? "ra-rich-text-input-error" : "", error: (isTouched || isSubmitted) && invalid },
      React13.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText })
    )
  );
};
export {
