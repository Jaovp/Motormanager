...
import { getAbsolutePath, log, logWarn, parseFireStoreDocument, } from '../../misc';
var ResourceManager = /** @class */ (function () {
    ...
    ResourceManager.prototype.RefreshResource = function (relativePath, collectionQuery) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var resource, collectionRef, collectionOrQuery, newDocs, count;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.sent();
                        resource = this.resources[relativePath];
                        collectionRef = resource.collection;
                        collectionOrQuery = this.applyQuery(collectionRef, collectionQuery);
                        return [4 /*yield*/, getDocs(collectionOrQuery)];
                    case 2:
                        newDocs = _c.sent();
                        newDocs.forEach(function (d) {
                            return resource.list.push(parseFireStoreDocument(d));
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, getDoc(doc(resource.collection, docId))];
                    case 2:
                        docSnap = _a.sent();
                        if (!docSnap.exists) {
