...
import { browserLocalPersistence, browserSessionPersistence, getAuth, inMemoryPersistence, onAuthStateChanged, signInWithEmailAndPassword, signOut, } from 'firebase/auth';
import { collection, doc, getFirestore, serverTimestamp as firestoreServerTimestamp, writeBatch, } from 'firebase/firestore';
...
var FirebaseWrapper = /** @class */ (function () {
    function FirebaseWrapper(inputOptions, firebaseConfig) {
        ...
        this._app = window['_app'] = ObtainFirebaseApp(firebaseConfig, optionsSafe);
    ...
    FirebaseWrapper.prototype.putFile = function (storagePath, rawFile) {
        var task = uploadBytesResumable(ref(this._storage, storagePath), rawFile);
        var taskResult = new Promise(function (res, rej) {
            return task.then(res).catch(rej);
        });
        var downloadUrl = taskResult
            .then(function (t) { return getDownloadURL(t.ref); })
    ...
    FirebaseWrapper.prototype.getStorageDownloadUrl = function (fieldSrc) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, getDownloadURL(ref(this._storage, fieldSrc))];
            });
        });
    };
    ...
    FirebaseWrapper.prototype.authSigninEmailPassword = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, signInWithEmailAndPassword(this._auth, email, password)];
                    case 1:
                        user = _a.sent();
    ...
    FirebaseWrapper.prototype.authSignOut = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, signOut(this._auth)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var auth = _this._auth;
                        if (auth.currentUser)
                            return resolve(auth.currentUser);
                        var unsubscribe = onAuthStateChanged(_this._auth, function (user) {
                            unsubscribe();
                            if (user) {
                                resolve(user);
                            }
...
function ObtainFirebaseApp(firebaseConfig, options) {
    ...
    var apps = getApps();
    var isInitialized = !!(apps === null || apps === void 0 ? void 0 : apps.length);
    if (isInitialized) {
        return getApp();
    }
    else {
