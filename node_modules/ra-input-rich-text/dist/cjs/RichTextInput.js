...
var RichTextInput = function (props) {
    var _a, _b;
    var className = props.className, _c = props.defaultValue, defaultValue = _c === void 0 ? '' : _c, _d = props.disabled, disabled = _d === void 0 ? false : _d, _e = props.editorOptions, editorOptions = _e === void 0 ? exports.DefaultEditorOptions : _e, fullWidth = props.fullWidth, helperText = props.helperText, label = props.label, _f = props.readOnly, readOnly = _f === void 0 ? false : _f, source = props.source, sx = props.sx, toolbar = props.toolbar;
