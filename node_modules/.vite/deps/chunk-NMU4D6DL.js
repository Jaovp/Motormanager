...
var require_get = __commonJS({
  "node_modules/lodash/get.js"(exports, module) {
    var baseGet = require_baseGet();
    function get12(object, path, defaultValue) {
...
var require_baseMatchesProperty = __commonJS({
  "node_modules/lodash/_baseMatchesProperty.js"(exports, module) {
    ...
    function baseMatchesProperty(path, srcValue) {
      ...
      return function(object) {
        var objValue = get12(object, path);
...
var QueryCache = function(_Subscribable) {
  ...
  _proto.get = function get12(queryHash) {
...
var useReferenceParams = function(_a) {
  ...
  var debouncedSetFilters = (0, import_react83.useRef)((0, import_debounce3.default)(function(filter2, displayedFilters) {
    changeParams({
      type: SET_FILTER,
      payload: {
...
var useReferenceInputController = function(props) {
  ...
  var _h = (0, import_react85.useState)(null), referenceRecord = _h[0], setReferenceRecord = _h[1];
...
var ShowContext = (0, import_react86.createContext)({
  record: null,
  defaultTitle: null,
  isFetching: null,
  isLoading: null,
...
var ShowBase = function(_a) {
  ...
  var body = React32.createElement(ShowContextProvider, { value: controllerProps }, children);
  return props.resource ? (
    // support resource override via props
    React32.createElement(ResourceContextProvider, { value: props.resource }, body)
  ) : body;
};
...
var useShowContext = function(props) {
  var context = (0, import_react87.useContext)(ShowContext);
...
var useCreate = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var paramsRef = (0, import_react88.useRef)(params);
...
var useUpdate = function(resource, params, options) {
  ...
  var mode = (0, import_react89.useRef)(mutationMode);
  var paramsRef = (0, import_react89.useRef)(params);
  var snapshot = (0, import_react89.useRef)([]);
...
var useDeleteMany = function(resource, params, options) {
  ...
  var paramsRef = (0, import_react92.useRef)({});
...
var PreferencesEditorContext = (0, import_react93.createContext)(void 0);

// node_modules/ra-core/dist/esm/preferences/PreferencesEditorContextProvider.js
var PreferencesEditorContextProvider = function(_a) {
  var children = _a.children;
  var _b = (0, import_react94.useState)(false), isEnabled = _b[0], setIsEnabled = _b[1];
  var _c = (0, import_react94.useState)(null), editor = _c[0], setEditor = _c[1];
  var _d = (0, import_react94.useState)(), preferenceKey = _d[0], setPreferenceKey = _d[1];
  var _e = (0, import_react94.useState)(null), path = _e[0], setPath = _e[1];
  var _f = (0, import_react94.useState)(null), title = _f[0], setTitleString = _f[1];
  var _g = (0, import_react94.useState)(), titleOptions = _g[0], setTitleOptions = _g[1];
  var enable = (0, import_react94.useCallback)(function() {
    return setIsEnabled(true);
  }, []);
  var disable = (0, import_react94.useCallback)(function() {
    setIsEnabled(false);
    setEditor(null);
  }, []);
  var setTitle = (0, import_react94.useCallback)(function(title2, titleOptions2) {
    setTitleString(title2);
    setTitleOptions(titleOptions2);
  }, []);
  var context = (0, import_react94.useMemo)(function() {
    return {
      editor,
      setEditor,
      preferenceKey,
  ...
  return React33.createElement(PreferencesEditorContext.Provider, { value: context }, children);
};
...
var ResourceDefinitionContext = (0, import_react95.createContext)({
  definitions: {},
  register: function() {
  },
  unregister: function() {
...
var ResourceDefinitionContextProvider = function(_a) {
  ...
  var _c = (0, import_react95.useState)(defaultDefinitions), definitions = _c[0], setState = _c[1];
  var register = (0, import_react95.useCallback)(function(config) {
  ...
  var unregister = (0, import_react95.useCallback)(function(config) {
    setState(function(prev) {
      var _a2 = prev, _b2 = config.name, _ = _a2[_b2], rest = __rest29(_a2, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return rest;
    });
  }, []);
  var contextValue = (0, import_react95.useMemo)(
    function() {
  ...
  return React34.createElement(ResourceDefinitionContext.Provider, { value: contextValue }, children);
};
...
var CoreAdminContext = function(props) {
  ...
  var finalQueryClient = (0, import_react96.useMemo)(function() {
    return queryClient || new QueryClient();
  }, [
    queryClient
  ]);
  var finalAuthProvider = (0, import_react96.useMemo)(function() {
    return authProvider instanceof Function ? convertLegacyAuthProvider_default(authProvider) : authProvider;
  }, [authProvider]);
  var finalDataProvider = (0, import_react96.useMemo)(function() {
            ...
            React35.createElement(
              ...
              React35.createElement(
                ...
                React35.createElement(
                  ...
                  null,
                  React35.createElement(ResourceDefinitionContextProvider, null, children)
                )
              )
            )
          )
...
var useResourceDefinitionContext = function() {
  return (0, import_react97.useContext)(ResourceDefinitionContext);
};
...
var useRoutesAndResourcesState = function(initialState) {
  var _a = (0, import_react98.useState)(initialState), routesAndResources = _a[0], setRoutesAndResources = _a[1];
  var mergeRoutesAndResources = (0, import_react98.useCallback)(function(newRoutesAndResources) {
...
var getRoutesAndResourceFromNodes = function(children) {
  ...
  var resources = [];
  import_react98.Children.forEach(children, function(element) {
    if (!React36.isValidElement(element)) {
      return;
    }
    if (element.type === import_react98.Fragment) {
...
var CoreAdminRoutes = function(props) {
  ...
  var _b = (0, import_react99.useState)(!requireAuth), canRender = _b[0], setCanRender = _b[1];
  ...
  if (status === "empty") {
    return React37.createElement(Ready, null);
  }
  if (status === "loading" || !canRender) {
    return React37.createElement(
      ...
      null,
      customRoutesWithoutLayout,
      oneSecondHasPassed ? React37.createElement(Route, { path: "*", element: React37.createElement(LoadingPage, null) }) : React37.createElement(Route, { path: "*", element: null })
    );
  }
  return React37.createElement(
    Routes,
    null,
    customRoutesWithoutLayout,
    React37.createElement(Route, { path: "/*", element: React37.createElement(
      "div",
      null,
      React37.createElement(
        ...
        React37.createElement(
          ...
          null,
          customRoutesWithLayout,
          import_react99.Children.map(resources, function(resource) {
            return React37.createElement(Route, { key: resource.props.name, path: "".concat(resource.props.name, "/*"), element: resource });
          }),
          React37.createElement(Route, { path: "/", element: dashboard ? React37.createElement(WithPermissions_default, { authParams: defaultAuthParams2, component: dashboard }) : resources.length > 0 ? React37.createElement(Navigate, { to: createPath2({
            resource: resources[0].props.name,
            type: "list"
          }) }) : null }),
          React37.createElement(Route, { path: "*", element: React37.createElement(CatchAll, { title }) })
        )
      )
    ) })
  );
...
var CoreAdminUI = function(props) {
  ...
  return React38.createElement(
    Routes,
    null,
    LoginPage !== false && LoginPage !== true ? React38.createElement(Route, { path: "/login", element: createOrGetElement(LoginPage) }) : null,
    LoginCallbackPage !== false && LoginCallbackPage !== true ? React38.createElement(Route, { path: "/auth-callback", element: createOrGetElement(LoginCallbackPage) }) : null,
    React38.createElement(Route, { path: "/*", element: React38.createElement(CoreAdminRoutes, { catchAll, dashboard, layout, loading, menu, requireAuth, ready, title }, children) })
  );
};
var createOrGetElement = function(el) {
  return (0, import_react100.isValidElement)(el) ? el : (0, import_react100.createElement)(el);
};
var Noop = function() {
  return null;
};
...
var CoreAdmin = function(props) {
  ...
  return React39.createElement(
    ...
    React39.createElement(CoreAdminUI, { layout, dashboard, disableTelemetry, menu, catchAll, title, loading, loginPage, requireAuth, ready }, children)
  );
};
...
var ResourceContext = (0, import_react101.createContext)(void 0);

// node_modules/ra-core/dist/esm/core/ResourceContextProvider.js
var ResourceContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return value ? React40.createElement(ResourceContext.Provider, { value }, children) : children;
};
...
var Resource = function(props) {
  ...
  return React41.createElement(
    ...
    React41.createElement(
      Routes,
      null,
      create && React41.createElement(Route, { path: "create/*", element: getElement(create) }),
      show && React41.createElement(Route, { path: ":id/show/*", element: getElement(show) }),
      edit && React41.createElement(Route, { path: ":id/*", element: getElement(edit) }),
      list && React41.createElement(Route, { path: "/*", element: getElement(list) }),
      props.children
    )
  );
};
var getElement = function(ElementOrComponent) {
  if ((0, import_react102.isValidElement)(ElementOrComponent)) {
    return ElementOrComponent;
  }
  if ((0, import_react_is.isValidElementType)(ElementOrComponent)) {
    return React41.createElement(ElementOrComponent, null);
  }
  return null;
};
...
var useResourceContext = function(props) {
  var context = (0, import_react103.useContext)(ResourceContext);
...
var useResourceDefinition = function(props) {
  ...
  var definition = (0, import_react104.useMemo)(function() {
...
var useGetRecordRepresentation = function(resource) {
  ...
  return (0, import_react105.useCallback)(function(record) {
    if (!record)
      return "";
    ...
    if (React42.isValidElement(recordRepresentation)) {
...
var useTranslate = function() {
  var i18nProvider = useI18nProvider();
  var translate = (0, import_react106.useCallback)(
...
var useTranslateLabel = function() {
  ...
  return (0, import_react107.useCallback)(function(_a) {
...
var useTranslatable = function(options) {
  ...
  var _b = (0, import_react108.useState)(defaultLocale), selectedLocale = _b[0], setSelectedLocale = _b[1];
  var resource = useResourceContext({});
  var translateLabel = useTranslateLabel();
  var context = (0, import_react108.useMemo)(function() {
    return {
...
var useTranslatableContext = function() {
  var context = (0, import_react109.useContext)(TranslatableContext);
  if (!context) {
...
var FieldTitle = function(props) {
  ...
  return React43.createElement(
    ...
    isRequired3 && React43.createElement("span", { "aria-hidden": "true" }, " *")
  );
};
FieldTitle.displayName = "FieldTitle";
var FieldTitle_default = (0, import_react110.memo)(FieldTitle);
...
var Button = function(_a) {
  ...
  var _b = (0, import_react111.useState)(false), hovered = _b[0], setHovered = _b[1];
...
function useWhyDidYouUpdate(name, props) {
  var previousProps = (0, import_react112.useRef)();
...
var useLayoutEffect3 = typeof window !== "undefined" ? React45.useLayoutEffect : React45.useEffect;
var useEvent = function(fn) {
  var ref = React45.useRef(function() {
    throw new Error("Cannot call an event handler while rendering.");
  });
  useLayoutEffect3(function() {
    ref.current = fn;
  });
  return (0, import_react113.useCallback)(function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
...
var LabelPrefixContext = (0, import_react114.createContext)("");
...
var useLabelPrefix = function() {
  return (0, import_react115.useContext)(LabelPrefixContext);
};
...
var LabelPrefixContextProvider = function(_a) {
  ...
  return React46.createElement(LabelPrefixContext.Provider, { value: newPrefix }, children);
};
...
var useStore = function(key, defaultValue) {
  ...
  var _b = (0, import_react116.useState)(function() {
...
var useRemoveFromStore = function(hookTimeKey) {
  ...
  return (0, import_react117.useCallback)(function(key) {
...
var useRemoveItemsFromStore = function(hookTimeKeyPrefix) {
  ...
  return (0, import_react118.useCallback)(function(keyPrefix) {
...
var useLogout = function() {
  ...
  var navigate = useNavigate();
  var navigateRef = (0, import_react119.useRef)(navigate);
  var location = useLocation();
  var locationRef = (0, import_react119.useRef)(location);
  var basename = useBasename();
  ...
  var logout = (0, import_react119.useCallback)(function(params, redirectTo, redirectToCurrentLocationAfterLogin) {
    if (params === void 0) {
      params = {};
    }
  ...
  var logoutWithoutProvider = (0, import_react119.useCallback)(function(_) {
    navigate({
      pathname: loginUrl
    }, {
      state: {
...
var useAuthState = function(params, logoutOnFailure, queryOptions) {
  ...
  return (0, import_react120.useMemo)(function() {
    var _a;
    return {
...
var isEmptyChildren = function(children) {
  return import_react122.Children.count(children) === 0;
};
var WithPermissions = function(props) {
  ...
  if (component) {
    return (0, import_react122.createElement)(component, __assign42({ permissions }, rest));
  }
  if (render) {
...
var useLogin = function() {
  ...
  var login = (0, import_react123.useCallback)(function(params, pathName) {
    if (params === void 0) {
      params = {};
    }
  ...
  var loginWithoutProvider = (0, import_react123.useCallback)(function(_, __) {
    resetNotifications();
...
var useGetPermissions = function() {
  var authProvider = useAuthProvider_default();
  var getPermissions = (0, import_react124.useCallback)(function(params) {
    if (params === void 0) {
      params = {};
    }
    return authProvider.getPermissions(params);
...
var Authenticated = function(props) {
  ...
  return React47.createElement(React47.Fragment, null, children);
};
...
var useCheckAuth = function() {
  ...
  var basename = useBasename();
  var loginUrl = removeDoubleSlashes2("".concat(basename, "/").concat(defaultAuthParams.loginUrl));
  var checkAuth = (0, import_react125.useCallback)(function(params, logoutOnFailure, redirectTo, disableNotification) {
    if (params === void 0) {
      params = {};
    }
    if (logoutOnFailure === void 0) {
...
var PreferenceKeyContext = (0, import_react127.createContext)("");
var PreferenceKeyContextProvider = function(_a) {
  var _b = _a.value, value = _b === void 0 ? "" : _b, children = _a.children;
  return React48.createElement(PreferenceKeyContext.Provider, { value }, children);
};
var usePreferenceKey = function() {
  return (0, import_react127.useContext)(PreferenceKeyContext);
};
...
var usePreferencesEditor = function() {
  return (0, import_react128.useContext)(PreferencesEditorContext);
};
...
var usePreferenceInput = function(key, defaultValue) {
  ...
  var _b = (0, import_react129.useState)(valueFromStore), value = _b[0], setValue = _b[1];
...
var FormDataConsumer = function(props) {
  ...
  return React49.createElement(FormDataConsumerView, __assign46({ formData }, props));
};
...
var FormGroupsContext = (0, import_react131.createContext)(void 0);
...
var ValidationError = function(props) {
  ...
  if (error.message) {
    ...
    return React50.createElement(React50.Fragment, null, translate(message, __assign47({ _: message }, args)));
  }
  return React50.createElement(React50.Fragment, null, translate(error, { _: error }));
};
...
var ChoicesContext = (0, import_react132.createContext)(void 0);

// node_modules/ra-core/dist/esm/form/choices/ChoicesContextProvider.js
var React51 = __toESM(require_react());
var ChoicesContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return React51.createElement(ChoicesContext.Provider, { value }, children);
};
...
var FormGroupsProvider = function(_a) {
  var children = _a.children;
  var formGroups = (0, import_react134.useRef)({});
  var subscribers = (0, import_react134.useRef)({});
  var formContextValue = (0, import_react134.useMemo)(function() {
    return {
      /**
  ...
  return React52.createElement(FormGroupsContext.Provider, { value: formContextValue }, children);
};
...
var useNotifyIsFormInvalid = function(control) {
  ...
  var submitCountRef = (0, import_react135.useRef)(submitCount);
  var notify = useNotify();
...
var useWarnWhenUnsavedChanges = function(enable, formRootPathname, control) {
  var navigator2 = (0, import_react136.useContext)(NavigationContext).navigator;
  var location = useLocation();
  var translate = useTranslate();
  ...
  var initialLocation = (0, import_react136.useRef)(formRootPathname || location.pathname);
...
var useAugmentedForm = function(props) {
  ...
  var defaultValuesIncludingRecord = (0, import_react137.useMemo)(
    function() {
  ...
  var formRef = (0, import_react137.useRef)(form);
  ...
  var handleSubmit = (0, import_react137.useCallback)(function(values, event) {
  ...
  var formHandleSubmit = (0, import_react137.useCallback)(function(event) {
    ...
    React53.createElement(
      ...
      React53.createElement(
        ...
        React53.createElement(
          FormGroupsProvider,
          null,
          React53.createElement("form", { onSubmit: formHandleSubmit, noValidate, id, className }, children)
        )
      )
    )
  );
...
var FormGroupContext = (0, import_react138.createContext)(void 0);
...
var useFormGroups = function() {
  var context = (0, import_react139.useContext)(FormGroupsContext);
  return context;
};
...
var FormGroupContextProvider = function(_a) {
  ...
  return React54.createElement(FormGroupContext.Provider, { value: name }, children);
};
...
var useChoices = function(_a) {
  ...
  var translate = useTranslate();
  var getChoiceText = (0, import_react142.useCallback)(function(choice) {
    if ((0, import_react142.isValidElement)(optionText)) {
      return React55.createElement(RecordContextProvider, { value: choice }, optionText);
    }
    var choiceName = typeof optionText === "function" ? optionText(choice) : (0, import_get10.default)(choice, optionText);
    return (0, import_react142.isValidElement)(choiceName) ? choiceName : translateChoice ? translate(String(choiceName), { _: choiceName }) : String(choiceName);
  }, [optionText, translate, translateChoice]);
  var getChoiceValue = (0, import_react142.useCallback)(function(choice) {
    return (0, import_get10.default)(choice, optionValue);
  }, [
    optionValue
  ]);
  var getDisableValue = (0, import_react142.useCallback)(function(choice) {
...
var useFormGroup = function(name) {
  ...
  var formGroups = useFormGroups();
  var _b = (0, import_react143.useState)({
    errors: void 0,
    isDirty: false,
    isTouched: false,
    isValid: true
  }), state = _b[0], setState = _b[1];
  var updateGroupState = (0, import_react143.useCallback)(function() {
...
var useFormGroupContext = function() {
  var context = (0, import_react144.useContext)(FormGroupContext);
  return context;
};
...
var useSuggestions = function(_a) {
  ...
  var getSuggestions = (0, import_react146.useCallback)(getSuggestionsFactory({
    allowCreate,
    choices: choices2,
    createText,
...
var defaultMatchSuggestion = function(getChoiceText) {
  return function(filter, suggestion, exact) {
    ...
    var isReactElement = (0, import_react146.isValidElement)(suggestionText);
...
var useUnique = function(options) {
  ...
  var translate = useTranslate();
  var record = useRecordContext();
  var debouncedGetList = (0, import_react147.useRef)(
  ...
  var validateUnique = (0, import_react147.useCallback)(function(callTimeOptions) {
...
var InferredElement = (
  ...
  function() {
    ...
    InferredElement2.prototype.getElement = function(props) {
      ...
      return this.children ? (0, import_react148.createElement)(this.type.component, __assign53(__assign53({}, this.props), props), this.children.length > 0 ? this.children.map(function(child, index) {
        return child.getElement({ key: index });
      }) : this.children.getElement()) : (0, import_react148.createElement)(this.type.component, __assign53(__assign53({}, this.props), props));
    };
...
var DefaultComponent = function() {
  return React56.createElement("span", null, ";");
};
var defaultType = {
...
inflection/lib/inflection.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NMU4D6DL.js.map
