...
export function initFireWrapper(projectId, rafOptions) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var safeId, testOptions, environment, context;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [2 /*return*/, new FirebaseWrapperStub(
                        // Slight (inconsequential) mismatch between test API and actual API
                        context.firestore(), context.storage(), rafOptions)];
            }
        });
    });
}
...
export function createDoc(db, collectionName, docName, obj) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setDoc(doc(collection(db, collectionName), docName), obj)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
export function getDocsFromCollection(db, collectionName) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getDocs(collection(db, collectionName))];
                case 1:
                    allDocs = _a.sent();
                    return [2 /*return*/, Promise.all(allDocs.docs.map(function (d) { return (__assign(__assign({}, d.data()), { id: d.id })); }))];
            }
        });
    });
}
