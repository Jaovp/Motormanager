...
import { AddCreatedByFields, AddUpdatedByFields, dispatch, log, logError, parseStoragePath, translateDocToFirestore, } from '../../misc';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        docPath = doc(r.collection, id).path;
                        ...
                        return [4 /*yield*/, Promise.all(uploads.map(function (u) { return __awaiter(_this, void 0, void 0, function () {
                                var storagePath, link;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            storagePath = parseStoragePath(u.rawFile, docPath, u.fieldDotsPath, !!this.options.useFileNamesInStorage);
                                            return [4 /*yield*/, this.saveFile(storagePath, u.rawFile)];
                                        case 1:
                                            link = _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all([downloadUrl, taskResult])];
                    case 2:
