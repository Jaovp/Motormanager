...
var FirebaseLazyLoadingClient = /** @class */ (function () {
    ...
    FirebaseLazyLoadingClient.prototype.apiGetList = function (resourceName, reactAdminParams) {
        return __awaiter(this, void 0, void 0, function () {
            var r, params, _a, noPagination, withPagination, snapshots, resultsCount, data, nextPageCursor, total, parsedData;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), noPagination = _a.noPagination, withPagination = _a.withPagination;
                        return [4 /*yield*/, getDocs(withPagination)];
                    case 3:
                        snapshots = _b.sent();
                        ...
                        return [4 /*yield*/, getCountFromServer(noPagination)];
                    case 4:
                        total = _b.sent();
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, { data: data, total: total.data().count }];
                }
            });
        });
    };
    FirebaseLazyLoadingClient.prototype.apiGetManyReference = function (resourceName, reactAdminParams) {
        return __awaiter(this, void 0, void 0, function () {
            var r, filterWithTarget, params, withPagination, snapshots, resultsCount, data, parsedData;
            var _a;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, paramsToQuery(r.collection, params, resourceName, this.client.flogger)];
                    case 2:
                        withPagination = (_b.sent()).withPagination;
                        return [4 /*yield*/, getDocs(withPagination)];
                    case 3:
                        snapshots = _b.sent();
                        resultsCount = snapshots.docs.length;
                        this.client.flogger.logDocument(resultsCount)();
                        data = snapshots.docs.map(parseFireStoreDocument);
